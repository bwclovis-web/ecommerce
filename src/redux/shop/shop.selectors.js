...
export const selectIsShopFetching = createSelector(selectShop, data => data.isFetching);

export const selectIsCollectionsLoaded = createSelector(selectShop, data => !!data.collections)